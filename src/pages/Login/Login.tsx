        ...
        <IonRow>
          <IonCol>
            <div className="login_welcome_message_container">
              <span className="login_welcome_message">Welcome Back!</span>
              <span className="login_welcome_title">Login to continue using weCab</span>
            </div>
          </IonCol>
        </IonRow>
          <IonRow>
              ...
              <IonRow>
                  <IonCol size="2">
                     <div className="phone_icon">
                       <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72.93 122.88"><path d="M10.94 0h51.04C68 0 72.93 4.93 72.93 10.94v100.99c0 6.02-4.93 10.94-10.94 10.94H10.95C4.93 122.88 0 117.95 0 111.94V10.95C0 4.93 4.93 0 10.94 0h0zm25.52 100.1c3.91 0 7.09 3.17 7.09 7.09a7.1 7.1 0 0 1-7.09 7.09c-3.92 0-7.09-3.17-7.09-7.09a7.1 7.1 0 0 1 7.09-7.09h0zM25.17 8.86h22.59c.16 0 .3.14.3.3v3.3c0 .16-.14.3-.3.3H25.17a.3.3 0 0 1-.3-.3h0v-3.3c0-.17.13-.3.3-.3h0zM9.65 21.53h53.63a1.79 1.79 0 0 1 1.78 1.78v70.01a1.8 1.8 0 0 1-1.78 1.78H9.65a1.79 1.79 0 0 1-1.78-1.78V23.3c0-.97.8-1.77 1.78-1.77h0z" fillRule="evenodd"/></svg>
                     </div>
                  </IonCol>
