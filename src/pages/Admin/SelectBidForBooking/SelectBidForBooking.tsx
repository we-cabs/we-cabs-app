...
const SelectBidForBooking: React.FC<SelectBidForBookingProps> = ({match,history}) => {
  ...
  const searchBookingById = (text:any)=>{
      ...
      let result = booking.filter((booking:any)=>booking.bookingId.indexOf(filter) >= 0);
