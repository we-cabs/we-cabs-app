...
import { IonPage, IonRow,IonCol,IonContent, IonAlert,IonCard,IonCardHeader } from '@ionic/react'
    ...
    return (
      ...
      <IonCard>
        <IonRow>
         ...
         <IonRow>
              <IonCol size="4">
                <span className="booking_title_op">User Id </span>
              </IonCol>
              <IonCol size="1">
                -
              </IonCol>
           ...
           <IonRow>
              <IonCol size="4">
              <span className="booking_title_op">Rating </span>
              </IonCol>
              <IonCol size="1">
                -
              </IonCol>
           ...
           <IonRow>
              <IonCol size="4">
              <span className="booking_title_op">Car Plate </span>
              </IonCol>
              <IonCol size="1">
                -
              </IonCol>
           ...
           <IonRow>
              <IonCol size="4">
              <span className="booking_title_op">Status </span>
              </IonCol>
              <IonCol size="1">
                -
              </IonCol>
          ...
          <IonRow>
             ...
             <IonRow>
                <IonCol className={"booking_bidding_list_inner_col_icon "+(bids.status == 'approved' ? 'success' : 'pending')}>
      ...
      <IonContent className="hide_overflow">
        <div className="inner_contant_container">
           ...
           <>
             ...
             <Virtuoso totalCount={bidData.length} itemContent={itemContent} className="vertual_list_scroll_booking_page" />  
           </>   
           :
